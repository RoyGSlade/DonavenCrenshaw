...
title: "Licenses"
layout: "default"
description: "A plain-language map of website, underplain, service, and Infinite Ages licensing scope."
date: "2026-07-31"
---

<p class="section-desc">Read the license that belongs to the thing you are using.</p>

## Website repository

The repository contains a root `LICENSE` file. That file is the source of truth for the repository's code and other material it actually covers. This overview does not silently expand or narrow its terms, and it does not turn every linked product or PDF into website code.
